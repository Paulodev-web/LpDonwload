...
const DOWNLOAD_URL =
  "https://appdistribution.firebase.dev/i/03557cb5103c4d42";
  ...
  return (
    <main className="relative isolate min-h-dvh overflow-hidden bg-white">
      <div
        ...
        aria-hidden
      >
        <div className="absolute left-1/2 top-[-24%] h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-blue-400/20 blur-[100px]" />
        <div className="absolute bottom-[-14%] right-[-10%] h-[320px] w-[320px] rounded-full bg-slate-200/70 blur-[90px]" />
      </div>
      ...
      <div className="mx-auto flex min-h-dvh max-w-lg flex-col px-4 pb-16 pt-10 sm:px-6 sm:pt-14">
        <header className="animate-landing-in mb-12 flex flex-col items-center gap-4 text-center sm:mb-16">
          <div className="surface-glass px-6 py-4 ring-1 ring-blue-500/20 sm:px-8 sm:py-5">
            <Image
              src={CLIENT_LOGO.src}
              alt={CLIENT_LOGO.alt}
              width={280}
          ...
          <div className="space-y-1.5">
            ...
            <p className="max-w-md text-pretty text-sm font-medium leading-snug text-slate-600 sm:text-base">
        ...
        <section className="animate-landing-in animation-delay-100 flex flex-1 flex-col items-center text-center">
          ...
          <p className="mb-10 max-w-md text-pretty text-base leading-relaxed text-slate-600 sm:text-lg">
          ...
          <a
            ...
            className="group inline-flex w-full max-w-sm items-center justify-center gap-3 rounded-xl bg-blue-800 px-8 py-4 text-lg font-semibold text-white shadow-lg shadow-blue-900/25 transition hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 active:scale-[0.99] active:bg-blue-900 sm:max-w-md sm:py-5 sm:text-xl"
          >
            <DownloadIcon className="h-6 w-6 shrink-0 text-white/95 transition group-hover:translate-y-0.5" />
            Baixar APK (Android)
          </a>
        </section>
        ...
        >
          <div className="surface-glass p-6 sm:p-8">
            <h3
              id="install-heading"
              className="mb-6 text-center text-lg font-bold tracking-tight text-slate-900"
            >
              Como instalar
            </h3>
            <ol className="space-y-5 text-left">
              {installSteps.map((step, index) => (
                <li
                  key={step.title}
                  className="animate-landing-in flex gap-4 border-b border-slate-200/90 pb-5 last:border-0 last:pb-0"
                  style={{
